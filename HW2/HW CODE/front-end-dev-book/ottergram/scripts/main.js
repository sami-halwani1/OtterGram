...
function checkNextHandler(cycle){
  'use strict';
...
function checkPrevHandler(cycle){
  'use strict';
  cycle.addEventListener('click', function(event){
    event.preventDefault();
      console.log(i);
...
function initializeEvents() {
  ...
  addKeyPressHandler();
  checkNextHandler(document.querySelector(BUTTON_NEXT));
  checkPrevHandler(document.querySelector(BUTTON_PREV));
